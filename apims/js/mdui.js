...
(function (global, factory) {
    ...
    mdui.prompt = function (label, title, onConfirm, onCancel, options) {
        ...
        var content = '<div class="mdui-textfield">' +
            ...
            (options.type === 'text'
                ? ("<input class=\"mdui-textfield-input mdui-color-light-blue-50\" type=\"text\" value=\"" + (options.defaultValue) + "\" " + (options.maxlength ? 'maxlength="' + options.maxlength + '"' : '') + "/>")
                : '') +
        ...
        return mdui.dialog({
            ...
            cssClass: 'mdui-dialog-prompt mdui-color-light-blue-50',
            history: options.history,
            modal: options.modal,
            closeOnEsc: options.closeOnEsc,
